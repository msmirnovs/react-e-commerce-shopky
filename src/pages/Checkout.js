          ...
          <div className='container mx-auto px-4'>
            ...
            <div className='flex flex-wrap -m-8 xl:-m-16'>
              ...
              <div className='w-full md:w-5/12 p-8 xl:p-16'>
                ...
                <button className='py-3 px-7 w-full text-sm text-white font-semibold bg-gray-900 hover:bg-gray-800 focus:bg-gray-800 focus:ring-4 focus:ring-gray-200 rounded-4xl transition duration-300'>
                  Continue to payment
                </button>
              </div>
            </div>
