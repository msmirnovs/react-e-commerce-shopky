              ...
              <div className='w-full md:w-7/12 p-8'>
                  ...
                  <div className='mb-4 border border-gray-100 rounded-lg'>
                    <div className='p-4 border-b border-gray-100'>
                      <div className='flex flex-wrap justify-between -m-2'>
                        ...
                        <div className='w-auto p-2'>
                          <img
                            src='shopky-assets/payment/payment-cards.png'
                            alt=''
                          />
                        </div>
                      </div>
                      ...
                      <div className='flex flex-wrap -m-2'>
                        ...
                        <div className='w-full lg:w-1/2 p-2'>
                          <label
                            ...
                            className='mb-1.5 inline-block text-sm'
                          >
                            CVV<span className='text-gray-500'>(3 digits)</span>
                          </label>
                          <input
                            id='input-01-4'
                            name='card-cvv'
                    ...
                    <div className='w-full p-2'>
                      <div className='p-4 border border-gray-100 rounded-lg'>
                        <div className='flex flex-wrap items-center justify-between -m-2'>
                          ...
                          <div className='w-auto p-2'>
                            <img
                              src='shopky-assets/payment/paypal.png'
                              alt=''
                            />
                          </div>
                        </div>
                          ...
                          <div className='w-auto p-2'>
                            <div className='flex flex-wrap items-center -m-1.5'>
                              <div className='w-auto p-1.5'>
                                <img
                                  src='shopky-assets/payment/spay.png'
                                  alt=''
                                />
                              </div>
                              <div className='w-auto p-1.5'>
                                <img
                                  src='shopky-assets/payment/dana.png'
                                  alt=''
                                />
                              </div>
                              <div className='w-auto p-1.5'>
                                <img
                                  src='shopky-assets/payment/ovo.png'
                                  alt=''
                                />
                              </div>
                            </div>
                ...
                <div className='px-4 py-6 border border-gray-100 rounded-lg'>
                  ...
                  <label className='relative flex items-center gap-2 mb-4'>
                    ...
                    <span className='text-sm'>Same as my shipping address</span>
                  </label>
                  <div className='mb-4'>
                    <label
                      htmlFor='input-01-5'
                ...
                <div className='px-4 py-6 border border-gray-200 rounded-2xl'>
                        ...
                        <div className='flex flex-wrap -m-2'>
                          <div className='w-auto p-2'>
                            <img
                              ...
                              src='shopky-assets/payment/order-summary.png'
                              alt=''
                            />
                          </div>
                          <div className='flex-1 p-2'>
                            <p className='mb-1.5'>Converse high</p>
                            <p className='mb-1.5 font-semibold'>Black</p>
                            <p>x1</p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className='pt-6'>
                    <div className='flex flex-wrap items-center justify-between -m-2'>
                      ...
                      <div className='w-auto p-2'>
                        <p className='text-2xl font-semibold'>$1220.00</p>
                      </div>
                    </div>
                  </div>
                </div>
